...
data_processed <- proportionalize(onlineShopperData, quote(ProductRelated_Duration), 
                    quote(Administrative_Duration), quote(Informational_Duration), 
                      quote(ProductRelated_Duration))
